...
- Não suprimir nem reformatar erros do Terminus — o `HealthExceptionFilter` captura `ServiceUnavailableException` exclusivamente para preservar o payload original do Terminus; não deve transformar, logar ou silenciar a resposta
