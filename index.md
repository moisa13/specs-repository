...
| [`setup/nestjs/nestjs-health`](./setup/nestjs/nestjs-health/README.md) | Endpoints de liveness e readiness via `@nestjs/terminus` com verificação de banco e memória | 0.2.0 | ✅ pronto |
| [`messaging/async-queue`](./messaging/async-queue/README.md) | Comportamento de produção e consumo de jobs em filas assíncronas, com retry e dead letter queue | 0.1.0 | 📝 rascunho |
| [`setup/nestjs/nestjs-queue`](./setup/nestjs/nestjs-queue/README.md) | Implementação de filas assíncronas com BullMQ e Redis em projetos NestJS, com módulo centralizado | 0.1.0 | 📝 rascunho |
