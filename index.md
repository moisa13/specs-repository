...
| [`caching/cache`](./caching/cache/README.md) | Comportamento de cache de dados com cache-aside, double-checked locking, invalidação e aquecimento no boot | 0.1.0 | 📝 rascunho |
| [`setup/nestjs/nestjs-cache`](./setup/nestjs/nestjs-cache/README.md) | Implementação de cache de dados em projetos NestJS usando ioredis, com CacheService, GenericCacheService e CacheWarmingService | 0.1.0 | 📝 rascunho |
