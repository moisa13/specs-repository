...
| [`observability/nestjs-health`](./observability/nestjs-health/README.md) | Endpoints de liveness e readiness via `@nestjs/terminus` com verificação de banco e memória | 0.1.0 | 📝 rascunho |
